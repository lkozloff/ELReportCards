...
$query = $sdbh->prepare("SELECT first_name,last_name FROM students WHERE student_id < 20");
$query->execute();
		...
		<table class = \"nooutline\">
			...
			<tr><td class = "noborder" align = "center">
				<table style = "width: 70%; border: none; margin-bottom: 2%;">		
					<tr><td class = "noborder"><b>Student</b></td><td class = "student" align = "right"><?php print $sname;?></td></tr>
	...
	function printRow($row){
		if($row['is_graded']){
			print("
					...
					<td align = \"center\" style = \"font-size:.normal;\" class=\"editGrade\">.</td>
					<td align = \"center\" style = \"font-size:normal;\" class=\"editEffort\">.</td>
					<td align = \"center\" style = \"font-size:normal;\" class=\"editGrade\">.</td>
					<td align = \"center\" style = \"font-size:normal;\" class=\"editEffort\">.</td>"
			);
